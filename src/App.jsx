...
function App() {
  ...
  return (
    <div className="app-shell">
      ...
      <footer><span>WeatherCheck<span className="brand-dot">.</span></span><span>Designed & Developed by Nikhil Patil. For Contact Visit: <a href="https://developwithnikhil.com/" target="_blank" rel="noreferrer">developwithnikhil.com</a></span><span>© {new Date().getFullYear()} Nikhil Patil - All Rights Reserved.</span></footer>
    </div>
  )
}
